...
- Authoritative contracts: `docs/api-contracts/`
...
- `docs/revised/01..07` and `docs/api-contracts/` are explicitly assigned by domain in spec and reflected in plan.
